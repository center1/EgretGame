module fighter
{
    ...
    export class GameContainer extends egret.DisplayObjectContainer
    {
        ...
        private hotpic2:egret.Bitmap;
        private full:egret.Bitmap;

        private hotpic1:egret.Bitmap;
    ...
    /*    private createBulletHandler(evt:egret.Event):void{
        ...
        private createEnemyFighter(evt:egret.TimerEvent):void{
            var enemyFighter:fighter.Airplane = fighter.Airplane.produce("hot1",1000);
